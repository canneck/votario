...
# events
votario.add_url_rule('/events', view_func=admin.create, methods=['POST'])
votario.add_url_rule('/events', view_func=admin.get_all, methods=['GET'])
votario.add_url_rule('/events/<int:event_id>', view_func=admin.get_by_id, methods=['GET'])
votario.add_url_rule('/events/<int:event_id>', view_func=admin.update, methods=['PUT'])
votario.add_url_rule('/events/<int:event_id>/status', view_func=admin.update_status, methods=['PATCH'])
votario.add_url_rule('/events/<int:event_id>', view_func=admin.delete, methods=['DELETE'])